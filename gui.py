...
class Ui_MainWindow(object):
    ...
    def refreshSerialPorts(self):
        # Lấy danh sách tất cả các cổng COM hiện có
        ports = serial.tools.list_ports.comports()
        port_names = [port.device for port in ports]

        # Cập nhật ComboBox với danh sách cổng COM
        self.SerialPortComboBox.clear()
        self.SerialPortComboBox.addItems(port_names)
    def connectToArduino(self):
        com_port = self.SerialPortComboBox.currentText()  # Lấy giá trị từ ComboBox
        baud_rate = self.BaudRateComboBox.currentText()  # Lấy giá trị từ ComboBox
        try:
            self.arduino = serial.Serial(port=com_port, baudrate=baud_rate, timeout=1)
            self.RobotStateDisplay.setText("Connected")
            self.RobotStateDisplay.setStyleSheet("color: green")
        except Exception as e:
            print(e)
            self.RobotStateDisplay.setText("Failed to connect")
    def sendHomeCommand(self):
        command = "HOME"  # Đây là chuỗi bạn muốn gửi
        self.arduino.write(command.encode())  # Gửi chuỗi xuống Arduino
    ...
    def setupUi(self, MainWindow):
        ...
        self.KillAlarmLockButton.setGeometry(QtCore.QRect(260, 120, 91, 25))
        ...
        self.InverseKinematicsLabel.setGeometry(QtCore.QRect(120, 300, 271, 31))
        font = QtGui.QFont()
        ...
        self.label_54.setGeometry(QtCore.QRect(580, 70, 271, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.ConsoleShowOkRespcheckBox.setGeometry(QtCore.QRect(710, 610, 151, 17))
        ...
        self.ConsoleLabel.setGeometry(QtCore.QRect(400, 600, 111, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.GripperLabel.setGeometry(QtCore.QRect(22, 10, 71, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.SerialPortLabel.setGeometry(QtCore.QRect(10, 20, 72, 22))
        self.SerialPortLabel.setMinimumSize(QtCore.QSize(72, 22))
        ...
        self.BaudRateLabel.setGeometry(QtCore.QRect(10, 50, 70, 22))
        self.BaudRateLabel.setMinimumSize(QtCore.QSize(70, 22))
        ...
        self.ConsoleShowVerbosecheckBox.setGeometry(QtCore.QRect(560, 610, 131, 17))
        ...
        self.FKGoAllButton.setGeometry(QtCore.QRect(590, 460, 75, 30))
        ...
        self.FKOutputValueFrame.setGeometry(QtCore.QRect(470, 540, 321, 21))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(390, 120, 501, 81))
        ...
        self.FKGoButtonArt1 = QtWidgets.QPushButton(parent=self.frame_7)
        self.FKGoButtonArt1.setGeometry(QtCore.QRect(450, 20, 35, 30))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(390, 200, 501, 81))
        ...
        self.FKGoButtonArt2 = QtWidgets.QPushButton(parent=self.frame_8)
        self.FKGoButtonArt2.setGeometry(QtCore.QRect(450, 20, 35, 30))
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(390, 280, 501, 81))
        ...
        self.FKGoButtonArt3 = QtWidgets.QPushButton(parent=self.frame_9)
        self.FKGoButtonArt3.setGeometry(QtCore.QRect(450, 20, 35, 30))
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(390, 360, 501, 81))
        ...
        self.FKGoButtonArt4 = QtWidgets.QPushButton(parent=self.frame_10)
        self.FKGoButtonArt4.setGeometry(QtCore.QRect(450, 20, 35, 30))
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(121, 341, 152, 164))
        self.layoutWidget4.setObjectName("layoutWidget4")
        self.gridLayout = QtWidgets.QGridLayout(self.layoutWidget4)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setSpacing(0)
        self.gridLayout.setObjectName("gridLayout")
        self.IkIncButtonY = QtWidgets.QPushButton(parent=self.layoutWidget4)
        ...
        self.IkDecButtonY = QtWidgets.QPushButton(parent=self.layoutWidget4)
        ...
        self.IkIncButtonX = QtWidgets.QPushButton(parent=self.layoutWidget4)
        ...
        self.IkDecButtonX = QtWidgets.QPushButton(parent=self.layoutWidget4)
        ...
        self.G0MoveRadioButton.setGeometry(QtCore.QRect(10, 170, 82, 17))
        ...
        self.FeedRateLabel.setGeometry(QtCore.QRect(210, 170, 61, 16))
        ...
        self.FeedRateInput.setGeometry(QtCore.QRect(279, 167, 71, 22))
        ...
        self.FeedRateInput.setProperty("value", 100.0)
        ...
        MainWindow.setTabOrder(self.SpinBoxArt1, self.SpinBoxArt2)
        MainWindow.setTabOrder(self.SpinBoxArt2, self.SpinBoxArt3)
        MainWindow.setTabOrder(self.SpinBoxArt3, self.SpinBoxArt4)
        MainWindow.setTabOrder(self.SpinBoxArt4, self.G0MoveRadioButton)
        ...
        MainWindow.setTabOrder(self.FKInc10ButtonArt1, self.FKDec0_1ButtonArt1)
        MainWindow.setTabOrder(self.FKDec0_1ButtonArt1, self.FKSliderArt1)
        MainWindow.setTabOrder(self.FKSliderArt1, self.FKSliderArt2)
        MainWindow.setTabOrder(self.FKSliderArt2, self.SliderGripper)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Robot Arm"))
        ...
        # Kết nối nút "Connect" với phương thức connectToArduino
        self.ConnectButton.clicked.connect(self.connectToArduino)
        self.SerialPortRefreshButton.clicked.connect(self.refreshSerialPorts)
        # Kết nối nút "Home" với phương thức sendHomeCommand
